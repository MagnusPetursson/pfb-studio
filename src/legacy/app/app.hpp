...
#define AURAL_APP(App) int main() { App.init(); renderer = &App.texture; aural::rnd::seedEngine(App.seed); aural::math::initNoise(App.seed); aural::flame::initFlame(); App.setup(); while(App.clock.getElapsedTime().asSeconds() < App.timeLimit) { App.loop(); } App.close(); return 0; }
