...
string NAME = "perlin2";
sf::RenderWindow& pfbPerlinWindow() {
    static sf::RenderWindow value;
    return value;
}
#define window (pfbPerlinWindow())
...
sf::RenderTexture& pfbPerlinRenderTexture() {
    static sf::RenderTexture value;
    return value;
}
#define renderTexture (pfbPerlinRenderTexture())
